...
//                $this->currentHeight = $height;
        ...
        protected static function getFFMpeg()
        {
            ...
            { echo json_encode(["error" => "INTERNAL_SERVER_ERROR", message => "Missing FFMpeg extension."]); exit; }
            return self::$ffmpeg;
        }
        ...
        protected static function getFFProbe()
        {
            ...
            if (self::$ffprobe == null)
            { echo json_encode(["error" => "INTERNAL_SERVER_ERROR", message => "Missing FFMpeg (FFProbe) extension."]); exit; }
            return self::$ffprobe;
        }
    }
}
