...
namespace File
{
    class Image
    {
        ...
        protected static function checkExtension()
        {
            ...
            { echo json_encode(["error" => "INTERNAL_SERVER_ERROR", message => "Missing GD extension."]); exit; }
        }
...
//        }
        ...
        public function render($type = self::FORMAT_PNG, $backgroundColor = null, $fileName = "", $cacheAgeInSeconds = 0)
        {
            ...
            if ($isDumped == true || \Connection::isCommandLine())
            {
                ...
                { echo \File::getContents($pixelerPath . ".blob"); exit; }
                ...
                echo $imagePixeler; exit;
            }

            exit; // after render, close (if not dumped)
        }
