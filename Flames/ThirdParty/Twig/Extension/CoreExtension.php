...
use Flames\ThirdParty\Twig\ExpressionParser;
use Flames\ThirdParty\Twig\Markup;
use Flames\ThirdParty\Twig\Node\Expression\Binary\AddBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\AndBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\BitwiseAndBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\BitwiseOrBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\BitwiseXorBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\ConcatBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\DivBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\EndsWithBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\EqualBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\FloorDivBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\GreaterBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\GreaterEqualBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\HasEveryBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\HasSomeBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\InBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\LessBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\LessEqualBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\MatchesBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\ModBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\MulBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\NotEqualBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\NotInBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\OrBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\PowerBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\RangeBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\SpaceshipBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\StartsWithBinary;
use Flames\ThirdParty\Twig\Node\Expression\Binary\SubBinary;
use Flames\ThirdParty\Twig\Node\Expression\Filter\DefaultFilter;
use Flames\ThirdParty\Twig\Node\Expression\NullCoalesceExpression;
use Flames\ThirdParty\Twig\Node\Expression\Test\ConstantTest;
use Flames\ThirdParty\Twig\Node\Expression\Test\DefinedTest;
use Flames\ThirdParty\Twig\Node\Expression\Test\DivisiblebyTest;
use Flames\ThirdParty\Twig\Node\Expression\Test\EvenTest;
use Flames\ThirdParty\Twig\Node\Expression\Test\NullTest;
use Flames\ThirdParty\Twig\Node\Expression\Test\OddTest;
use Flames\ThirdParty\Twig\Node\Expression\Test\SameasTest;
use Flames\ThirdParty\Twig\Node\Expression\Unary\NegUnary;
use Flames\ThirdParty\Twig\Node\Expression\Unary\NotUnary;
use Flames\ThirdParty\Twig\Node\Expression\Unary\PosUnary;
use Flames\ThirdParty\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use Flames\ThirdParty\Twig\Source;
use Flames\ThirdParty\Twig\Template;
use Flames\ThirdParty\Twig\TemplateWrapper;
use Flames\ThirdParty\Twig\TokenParser\ApplyTokenParser;
use Flames\ThirdParty\Twig\TokenParser\BlockTokenParser;
use Flames\ThirdParty\Twig\TokenParser\DeprecatedTokenParser;
use Flames\ThirdParty\Twig\TokenParser\DoTokenParser;
use Flames\ThirdParty\Twig\TokenParser\EmbedTokenParser;
use Flames\ThirdParty\Twig\TokenParser\ExtendsTokenParser;
use Flames\ThirdParty\Twig\TokenParser\FlushTokenParser;
use Flames\ThirdParty\Twig\TokenParser\ForTokenParser;
use Flames\ThirdParty\Twig\TokenParser\FromTokenParser;
use Flames\ThirdParty\Twig\TokenParser\IfTokenParser;
use Flames\ThirdParty\Twig\TokenParser\ImportTokenParser;
use Flames\ThirdParty\Twig\TokenParser\IncludeTokenParser;
use Flames\ThirdParty\Twig\TokenParser\MacroTokenParser;
use Flames\ThirdParty\Twig\TokenParser\SetTokenParser;
use Flames\ThirdParty\Twig\TokenParser\UseTokenParser;
use Flames\ThirdParty\Twig\TokenParser\WithTokenParser;
...
final class CoreExtension extends AbstractExtension
{
    ...
    {
        if (!$arrow instanceof \Closure && $env->hasExtension('\Flames\ThirdParty\Twig\Extension\SandboxExtension') && $env->getExtension('\Flames\ThirdParty\Twig\Extension\SandboxExtension')->isSandboxed()) {
