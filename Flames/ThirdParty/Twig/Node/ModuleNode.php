...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use Flames\ThirdParty\Twig\Environment;\n")
                ->write("use Flames\ThirdParty\Twig\Error\LoaderError;\n")
                ->write("use Flames\ThirdParty\Twig\Error\RuntimeError;\n")
                ->write("use Flames\ThirdParty\Twig\Extension\CoreExtension;\n")
                ->write("use Flames\ThirdParty\Twig\Extension\SandboxExtension;\n")
                ->write("use Flames\ThirdParty\Twig\Markup;\n")
                ->write("use Flames\ThirdParty\Twig\Sandbox\SecurityError;\n")
                ->write("use Flames\ThirdParty\Twig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use Flames\ThirdParty\Twig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use Flames\ThirdParty\Twig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use Flames\ThirdParty\Twig\Source;\n")
                ->write("use Flames\ThirdParty\Twig\Template;\n\n")
            ;
        }
        $compiler
