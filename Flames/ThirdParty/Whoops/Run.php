...
namespace Flames\ThirdParty\Whoops;

use Flames\ThirdParty\Whoops\Exception\ErrorException;
use Flames\ThirdParty\Whoops\Handler\CallbackHandler;
use Flames\ThirdParty\Whoops\Handler\Handler;
use Flames\ThirdParty\Whoops\Handler\HandlerInterface;
use Flames\ThirdParty\Whoops\Inspector\InspectorFactory;
use Flames\ThirdParty\Whoops\Inspector\InspectorFactoryInterface;
use Flames\ThirdParty\Whoops\Inspector\InspectorInterface;
use Flames\ThirdParty\Whoops\Util\Misc;
use Flames\ThirdParty\Whoops\Util\SystemFacade;
...
final class Run implements RunInterface
{
    ...
    public function register()
    {
        if (!$this->isRegistered) {
            ...
            class_exists("\\Flames\\ThirdParty\\Whoops\\Exception\\ErrorException");
            class_exists("\\Flames\\ThirdParty\\Whoops\\Exception\\FrameCollection");
            class_exists("\\Flames\\ThirdParty\\Whoops\\Exception\\Frame");
            class_exists("\\Flames\\ThirdParty\\Whoops\\Exception\\Inspector");
            class_exists("\\Flames\\ThirdParty\\Whoops\\Inspector\\InspectorFactory");
