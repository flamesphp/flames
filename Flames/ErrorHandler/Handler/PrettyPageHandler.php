...
use Flames\ErrorHandler\Exception\Formatter;
use Flames\ErrorHandler\Util\Misc;
use Flames\ErrorHandler\Util\TemplateHelper;
use Flames\Kernel;
...
class PrettyPageHandler extends Handler
{
    ...
    public function addDataTableCallback($label, /* callable */ $callback)
    {
        ...
        $this->extraTables[$label] = function (\Flames\ErrorHandler\Inspector\InspectorInterface $inspector = null) use ($callback) {
            try {
