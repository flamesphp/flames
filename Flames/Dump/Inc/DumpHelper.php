...
class DumpHelper
{
    ...
    public static function shortenPath($file)
    {
        ...
        // Find common path with Dump dir
        if (!isset(self::$projectRootDir)) {
            self::$projectRootDir = '';

            $sagePathParts = explode('/', str_replace('\\', '/', DUMP_DIR));
    ...
    /**
     * returns whether current trace step belongs to Dump or its wrappers
     *
     * @param $step
     *
     * @return bool
    ...
    public static function ideLink($file, $line, $linkText = null)
    {
        ...
        if (empty($localPath) === false && empty($remotePath) === false) {
