...
use Flames\Template\Node\NodeCaptureInterface;
use Flames\Template\Node\NodeOutputInterface;
...
class Parser
{
    ...
    private function filterBodyNodes(Node $node, bool $nested = false): ?Node
    {
        ...
        if (
            ...
            throw new SyntaxError('A template that extends another one cannot include content outside Template blocks. Did you forget to put the content inside a {% block %} tag?', $node->getTemplateLine(), $this->stream->getSourceContext());
        }
