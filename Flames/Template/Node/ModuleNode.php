...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use Flames\Template\Environment;\n")
                ->write("use Flames\Template\Error\LoaderError;\n")
                ->write("use Flames\Template\Error\RuntimeError;\n")
                ->write("use Flames\Template\Extension\CoreExtension;\n")
                ->write("use Flames\Template\Extension\SandboxExtension;\n")
                ->write("use Flames\Template\Markup;\n")
                ->write("use Flames\Template\Sandbox\SecurityError;\n")
                ->write("use Flames\Template\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use Flames\Template\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use Flames\Template\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use Flames\Template\Source;\n")
                ->write("use Flames\Template\Template;\n\n")
            ;
        }
        $compiler
