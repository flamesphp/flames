...
abstract class IntegrationTestCase extends TestCase
{
     ...
     */
    protected function getTemplateFilters()
    {
        return [];
    }
     ...
     * @return TemplateTest[]
     */
    protected function getTemplateTests()
    {
        return [];
    }
    ...
    protected function doIntegrationTest($file, $message, $condition, $templates, $exception, $outputs, $deprecation = '')
    {
        ...
        foreach ($outputs as $i => $match) {
            ...
            foreach ($this->getTemplateFilters() as $filter) {
                $twig->addFilter($filter);
            }

            foreach ($this->getTemplateTests() as $test) {
                $twig->addTest($test);
            }

            foreach ($this->getTemplateFunctions() as $function) {
            ...
            $p->setValue($twig, '__TemplateTemplate_'.hash(\PHP_VERSION_ID < 80100 ? 'sha256' : 'xxh128', uniqid(mt_rand(), true), false).'_');
