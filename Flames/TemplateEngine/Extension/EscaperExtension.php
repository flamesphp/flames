...
use Flames\TemplateEngine\FileExtensionEscapingStrategy;
...
use Flames\TemplateEngine\NodeVisitor\EscaperNodeVisitor;
use Flames\TemplateEngine\TemplateEngineFilter;
use Flames\TemplateEngine\TokenParser\AutoEscapeTokenParser;
...
final class EscaperExtension extends AbstractExtension
{
    ...
    {
        return [
            new TemplateEngineFilter('escape', [self::class, 'escape'], ['needs_environment' => true, 'is_safe_callback' => [self::class, 'escapeFilterIsSafe']]),
            new TemplateEngineFilter('e', [self::class, 'escape'], ['needs_environment' => true, 'is_safe_callback' => [self::class, 'escapeFilterIsSafe']]),
            new TemplateEngineFilter('raw', [self::class, 'raw'], ['is_safe' => ['all']]),
        ];
    }
