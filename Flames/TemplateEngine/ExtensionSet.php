...
use Flames\TemplateEngine\Extension\GlobalsInterface;
use Flames\TemplateEngine\Extension\StagingExtension;
...
final class ExtensionSet
{
    ...
    private $parsers;
    private $visitors;
    /** @var array<string, TemplateEngineFilter> */
    private $filters;
    /** @var array<string, TemplateEngineTest> */
    private $tests;
    /** @var array<string, TemplateEngineFunction> */
    private $functions;
    ...
    private function initExtension(ExtensionInterface $extension): void
    {
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            if (!$parser instanceof TokenParserInterface) {
                throw new \LogicException('getTokenParsers() must return an array of \TemplateEngine\TokenParser\TokenParserInterface.');
            }
