...
use Flames\TemplateEngine\Node\Expression\ArrayExpression;
use Flames\TemplateEngine\Node\Expression\ArrowFunctionExpression;
...
use Flames\TemplateEngine\Node\Expression\BlockReferenceExpression;
...
use Flames\TemplateEngine\Node\Expression\ParentExpression;
...
class ExpressionParser
{
    ...
    private function getTestNodeClass(TemplateEngineTest $test): string
    {
        if ($test->isDeprecated()) {
            $stream = $this->parser->getStream();
            $message = sprintf('TemplateEngine Test "%s" is deprecated', $test->getName());
    ...
    private function getFunctionNodeClass(string $name, int $line): string
    {
        ...
        if ($function->isDeprecated()) {
            $message = sprintf('TemplateEngine Function "%s" is deprecated', $function->getName());
    ...
    private function getFilterNodeClass(string $name, int $line): string
    {
        ...
        if ($filter->isDeprecated()) {
            $message = sprintf('TemplateEngine Filter "%s" is deprecated', $filter->getName());
