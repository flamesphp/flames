...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use Flames\TemplateEngine\Environment;\n")
                ->write("use Flames\TemplateEngine\Error\LoaderError;\n")
                ->write("use Flames\TemplateEngine\Error\RuntimeError;\n")
                ->write("use Flames\TemplateEngine\Extension\CoreExtension;\n")
                ->write("use Flames\TemplateEngine\Extension\SandboxExtension;\n")
                ->write("use Flames\TemplateEngine\Markup;\n")
                ->write("use Flames\TemplateEngine\Sandbox\SecurityError;\n")
                ->write("use Flames\TemplateEngine\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use Flames\TemplateEngine\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use Flames\TemplateEngine\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use Flames\TemplateEngine\Source;\n")
                ->write("use Flames\TemplateEngine\Template;\n\n")
            ;
        }
        $compiler
